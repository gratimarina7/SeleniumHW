...
{
    class CancelAddNewBusinessObjective
    {
        ...
        public CancelAddNewBusinessObjective(IWebDriver driver, WebDriverWait wait)
        {
            _driver = driver;
            _wait = wait;
        }
        ...
        private IWebElement selectStatusField => _driver.FindElement(By.XPath("//span[@class='mat-option-text'][normalize-space()='In progress']"));
        private IWebElement clickPriorityField => _driver.FindElement(By.XPath("//mat-select[@formcontrolname='priorityId']"));
        private IWebElement selectPriorityField => _driver.FindElement(By.XPath("//span[normalize-space()='High']"));
        ...
        private IWebElement selectDeadlineDate => _driver.FindElement(By.XPath("//div[normalize-space()='30']"));
        private IWebElement saveBusinessObjective => _driver.FindElement(By.XPath("//span[normalize-space()='Save']"));
        ...
        public void ClickOnCalendar()
         ...
         public void CancelToSaveNewBusinessObjective()
          {
              _wait.Until(ExpectedConditions.ElementToBeClickable(canceltoAddBusinessObjective)).Click();
          }
     }
